              ...
              <div className="flex gap-2 w-full mt-4">
                {contact.phone && (
                  ...
                  >
                    ...
                    <span className="text-[10px] font-bold uppercase" style={{ color: "#9A9088" }}>WhatsApp</span>
                  </a>
                )}
                {contact.phone && (
                  <a
                  ...
                  >
                    ...
                    <span className="text-[10px] font-bold uppercase" style={{ color: "#9A9088" }}>Llamar</span>
                  </a>
                )}
                {contact.email && (
                  <a
                  ...
                  >
                    ...
                    <span className="text-[10px] font-bold uppercase" style={{ color: "#9A9088" }}>Email</span>
                  </a>
                )}
              </div>
            </div>
            ...
            {topDeal && (
              ...
              >
                ...
                {topDeal.deal_value != null && (
                  <div>
                    <p className="text-xs font-medium" style={{ color: "#9A9088" }}>Valor Estimado</p>
                    <p
            ...
            <div className="space-y-4">
              ...
              <div style={{ borderBottom: "1px solid rgba(255,255,255,0.07)", paddingBottom: 16 }}>
                ...
                <div className="grid grid-cols-2 gap-4">
                  {contact.phone && (
                    <div>
                      <p className="text-xs" style={{ color: "#9A9088" }}>Celular</p>
                      <p className="text-sm font-semibold" style={{ color: "#e5e2e1" }}>{contact.phone}</p>
                    </div>
                  )}
                  {contact.email && (
                    <div>
                      <p className="text-xs" style={{ color: "#9A9088" }}>Email</p>
                      <p className="text-sm font-semibold truncate" style={{ color: "#e5e2e1" }}>{contact.email}</p>
                    </div>
                  )}
                  {contact.lead_status && (
                    <div>
                      <p className="text-xs" style={{ color: "#9A9088" }}>Estado</p>
                  ...
                  {contact.source && (
                    <div>
                      <p className="text-xs" style={{ color: "#9A9088" }}>Origen</p>
                      <p className="text-sm font-semibold capitalize" style={{ color: "#e5e2e1" }}>{contact.source.replace(/_/g, " ")}</p>
                    </div>
                  )}
                </div>
              </div>
                    ...
                    {(tasks ?? []).slice(0, 3).map((task) => (
                      <div key={task.id} className="flex items-start gap-2">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-xs font-semibold leading-snug" style={{ color: "#e5e2e1" }}>{task.title}</p>
                          {task.due_date && (
                            <p className="text-[10px]" style={{ color: "#6B6158" }}>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-xs font-bold" style={{ color: "#e5e2e1" }}>Contacto creado</p>
                      <p className="text-[10px]" style={{ color: "#6B6158" }}>
                  ...
                  {topDeal && (
                    <div className="flex gap-3">
                      ...
                      <div>
                        <p className="text-xs font-bold" style={{ color: "#e5e2e1" }}>Deal en {STAGE_LABELS[topDeal.stage]}</p>
                        <p className="text-[10px]" style={{ color: "#6B6158" }}>
                  ...
                  {(deals as unknown as Deal[]).map((d) => (
                    ...
                    >
                      <div className="flex justify-between items-start mb-2">
                        ...
                        {d.deal_value != null && (
                          <span className="text-sm font-extrabold" style={{ color: "#e5e2e1", fontFamily: "var(--font-manrope), Manrope, sans-serif" }}>
