        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          {entries.map((entry, i) => (
            <div
              key={entry.agent_id}
              style={{
                background: entry.is_active ? CARD : "rgba(14,15,20,0.6)",
                backdropFilter: "blur(12px)",
                border: `1px solid ${entry.is_active ? BORDER : "rgba(255,255,255,0.05)"}`,
                borderRadius: 14,
                padding: "14px 20px",
                display: "flex",
                alignItems: "center",
            ...
            >
              ...
              <div style={{
                ...
                color: entry.is_active ? GOLD : TEXT_MUTED,
                flexShrink: 0,
              }}>
                {i + 1}
              </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 2, flexShrink: 0 }}>
                <button
                  ...
                  style={{
                    ...
                    color: i === 0 ? "rgba(255,255,255,0.1)" : TEXT_MUTED,
                    lineHeight: 1,
                  }}
                >
                  <ChevronUp size={14} />
                ...
                <button
                  ...
                  style={{
                    ...
                    color: i === entries.length - 1 ? "rgba(255,255,255,0.1)" : TEXT_MUTED,
                    lineHeight: 1,
                  }}
                >
                  <ChevronDown size={14} />
              ...
              {/* Agent info */}
              <div style={{ flex: 1 }}>
                <p style={{ fontFamily: "Manrope, sans-serif", fontWeight: 700, fontSize: 14, color: TEXT_PRIMARY, margin: "0 0 2px" }}>
                  {entry.full_name}
                </p>
              ...
              >
                <span style={{
                  ...
                  background: entry.is_active ? "#22c55e" : "rgba(255,255,255,0.2)",
                  flexShrink: 0,
                }} />
                <span style={{
                  fontSize: 11, fontWeight: 700,
                  color: entry.is_active ? "#22c55e" : TEXT_MUTED,
                  whiteSpace: "nowrap",
                }}>
          ...
          {entries.length === 0 && (
            <div style={{ textAlign: "center", padding: "64px 0", color: TEXT_MUTED }}>
              <Users size={40} color={BORDER} style={{ margin: "0 auto 16px" }} />
